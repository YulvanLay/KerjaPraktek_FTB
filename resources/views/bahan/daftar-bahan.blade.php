                    ...
                    @if(Auth()->user()->laboran || Auth()->user()->kalab || Auth()->user()->koordinator)
                        ...
                        <td style="white-space: nowrap;">
                            <a class="btn btn-link"
                                href="{{ action('BahanController@getDetailBahanPemakaian', $bahan->kode_bahan) }}"
                            ...
                            @if(Auth()->user()->laboran)
                                <a class="btn btn-link" href="#" title="Ubah" aria-label="Ubah" data-toggle="modal"
                                    data-target="#modalEdit" onclick="showModalEdit('{{ $bahan->kode_bahan }}');"><i
                                ...
                                @if(!$bahan->detailPemakaianBahans()->exists() && !$bahan->detailPenerimaanBahans()->exists() && auth()->user()->hak_akses_delete)
                                    <a class="btn btn-link" href="#" data-toggle="modal" data-target="#modalHapus" title="Hapus"
                                        aria-label="Hapus"
                                        onclick="updateModal('{{ $bahan->nama_bahan }}'); hapus('{{ $bahan->kode_bahan }}');"><i
                ...
                <div class="modal-body">
                    <form id="formTambah" action="{{ action('BahanController@store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="kode_bahan">Kode Bahan<span class="text-danger">
                                    *</span></label>
                            <input type="text" class="form-control" id="kode_bahan" name="kode_bahan" autocomplete="off"
                                value="{{ old('kode_bahan') }}">
                            <span class="help-block">{{ $errors->first('kode_bahan', ':message') }}</span>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label" for="nama_bahan">Nama Bahan<span class="text-danger">
                                    *</span></label>
                            <input type="text" class="form-control" id="nama_bahan" name="nama_bahan" autocomplete="off"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kode_sinta" name="kode_sinta" autocomplete="off"
                                value="{{ old('kode_sinta') }}">
                        ...
                        <div class="form-row ml-1">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="harga" name="harga" autocomplete="off"
                                    step="100" min="0" value="{{ old('harga', 0) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="stok" name="stok" autocomplete="off"
                                    step="0.1" min="0" value="{{ old('stok', 0) }}">
                        ...
                        <div class="form-row ml-1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="min_stok" name="min_stok" autocomplete="off"
                                    step="0.1" min="0" value="{{ old('min_stok', 0) }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formEdit" action="" method="POST">
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="ubah_kode_bahan">Kode Bahan<span class="text-danger">
                                    *</span></label>
                            <input id="ubah_kode_bahan" type="text" class="form-control" name="ubah_kode_bahan"
                                autocomplete="off">
                            <span class="help-block">{{ $errors->first('ubah_kode_bahan', ':message') }}</span>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label" for="ubah_nama_bahan">Nama Bahan<span class="text-danger">
                                    *</span></label>
                            <input id="ubah_nama_bahan" type="text" class="form-control" id="ubah_nama_bahan"
                                name="ubah_nama_bahan" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input id="ubah_kode_sinta" type="text" class="form-control" id="ubah_kode_sinta"
                                name="ubah_kode_sinta" autocomplete="off">
                        ...
                        <div class="form-row ml-1">
                            <div class="form-group">
                                ...
                                <input id="ubah_harga" type="number" class="form-control" id="ubah_harga" name="ubah_harga"
                            ...
                            <div class="form-group">
                                ...
                                <input id="ubah_stok" type="number" class="form-control" id="ubah_stok" name="ubah_stok"
                                    autocomplete="off" step="0.1" min="0">
                        ...
                        <div class="form-row ml-1">
                            <div class="form-group">
                                ...
                                <input id="ubah_satuan" type="text" class="form-control" id="ubah_satuan" name="ubah_satuan"
                                    autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <input id="ubah_min_stok" type="number" class="form-control" id="ubah_min_stok"
                                    name="ubah_min_stok" autocomplete="off" step="0.1" min="0">
