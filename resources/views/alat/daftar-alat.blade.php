                ...
                <tr>
                    ...
                    @if(Auth()->user()->laboran || Auth()->user()->kalab || Auth()->user()->koordinator)
                        ...
                        <td style="white-space: nowrap;">
                            <a class="btn btn-link" href="{{ action('AlatController@getDetailAlatPeminjaman', $alat->kode_alat) }}"
                            ...
                            @if(Auth()->user()->laboran)
                                <a class="btn btn-link" href="#" title="Ubah" aria-label="Ubah" data-toggle="modal"
                                    data-target="#modalEdit" onclick="showModalEdit('{{ $alat->kode_alat }}');"><i
                                ...
                                @if(!$alat->detailPembelianAlats()->exists() && !$alat->detailPinjam()->exists() && auth()->user()->hak_akses_delete)
                                    <a class="btn btn-link" href="#" data-toggle="modal" data-target="#modalHapus" title="Hapus"
                                        aria-label="Hapus"
                                        onclick="updateModal('{{ $alat->nama_alat }}'); hapus('{{ $alat->kode_alat }}');"><i
                ...
                <div class="modal-body">
                    <form id="formTambah" action="{{ action('AlatController@store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="nama_alat">Nama Alat<span class="text-danger">
                                    *</span></label>
                            <input type="text" class="form-control" id="nama_alat" name="nama_alat" autocomplete="off"
                                value="{{ old('nama_alat') }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formEdit" action="" method="POST">
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="ubah_nama_alat">Nama Alat<span class="text-danger">
                                    *</span></label>
                            <input id="ubah_nama_alat" type="text" class="form-control" id="ubah_nama_alat"
                                name="ubah_nama_alat" autocomplete="off">
