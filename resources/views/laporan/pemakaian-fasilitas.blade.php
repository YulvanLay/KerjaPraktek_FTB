...
@section('title', 'Laporan Pemakaian Fasilitas')
...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-6">
            <h2>Laporan Pemakaian Fasilitas</h2>
        </div>
    </div><br>
    <div class="row">
        <div class="col-sm-6">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#pelanggan').on('change', function () {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/pemakaian-fasilitas/' + this.value,
                    success: function (data) {
                        dt.clear().draw();
                        if (data) {
                            for (var i = 0; i < data.length; i++) {
                                var url = "{{ url('/invoice-pemakaian-fasilitas/:pelanggan/:keperluan/:periode') }}";
