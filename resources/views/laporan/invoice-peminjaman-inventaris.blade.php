...
<body>
    ...
    <div class="container-fluid p-3">
        ...
        <h3 class="text-center p-2" style="font-weight: bold; color: #038778;">Form Peminjaman Inventaris</h3>
            ...
            <tbody>
                ...
                @foreach($peminjamans as $peminjaman)
                    <tr>
                        ...
                        @if($shouldEcho)
                            <td class="text-center" rowspan="{{ $rowSpans[$rowSpanCounter] }}" style="vertical-align : middle;">
