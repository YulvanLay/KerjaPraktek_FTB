            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    @if(Auth::user()->laboran || Auth::user()->koordinator || Auth::user()->kalab)
                        ...
                        <li
                            class="nav-item dropdown{{ request()->is('inventaris*') || request()->is('pinjam-inventaris*') ? ' active' : '' }}">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                Inventaris Lab
                            </a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ url('inventaris') }}">Daftar Inventaris</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ url('pinjam-inventaris') }}">Peminjaman Inventaris</a>
                            </div>
                        </li>
                        <li
                            class="nav-item dropdown{{ request()->is('fasilitas*') || request()->is('pakai-fasilitas*') ? ' active' : '' }}">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                Fasilitas Lab
                            </a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ url('fasilitas') }}">Daftar Fasilitas</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ url('pakai-fasilitas') }}">Pemakaian Fasilitas</a>
                            </div>
                        </li>
                        {{------- END -------}}
                        ...
                        <li
                            ...
                            <div class="dropdown-menu">
                                ...
                                {{------- Tambahan Menu Laporan Inventaris & Fasilitas Lab -------}}
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ url('laporan-peminjaman-inventaris') }}">Laporan Peminjaman
                                    Inventaris</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ url('inventaris-tidakterpakai') }}">Inventaris Belum
                                    Kembali</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ url('laporan-pemakaian-fasilitas') }}">Laporan Pemakaian
                                    Fasilitas</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ url('fasilitas-tidakterpakai') }}">Pemakaian Fasilitas Belum
                                    Selesai Verifikasi</a>
                                {{------ END -------}}
